...
import { Member } from "@/features/memebers/types";
...
export const TaskList = ({ data, total }: TaskListProps) => {
  ...
  return (
    <div className="flex flex-col gapo-y-4 col-span-1">
      <div className="bg-muted rounded-lg p-4">
        <div className="flex items-center justify-between">
          <p className="text-lg font-semibold">
            Tasks ({total})
          </p>
          <Button variant="muted" size="icon" onClick={() => createTask(undefined)}>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      ...
                      <div className="text-sm text-muted-foreground flex items-center">
                        <CalendarIcon className="sizae-3 mr-1" />
    ...
    <div className="flex flex-col gapo-y-4 col-span-1">
      <div className="bg-white border rounded-lg p-4">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.map((member) => (
            <li key={member.$id}>
              <Card className="shadow-none rounded-lg overfleow-hidden">
