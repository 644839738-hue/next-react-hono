...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
  ...
  const {
    ...
    isPending: isResettingInvieCode,
  } = useResetInviteCode();
  ...
  const form = useForm<z.infer<typeof updateWorkspaceSchema>>({
    ...
    defaultValues: {
      ...initialValues,
      image: initialValues.imageUrl ?? "",// 这里接收服务端传来的完整 URL
    },
  });
  ...
  // console.log("Image URL:", initialValues.imageUrl);
          ...
          <div className="felx flex-col">
            ...
            <div className="mt-4">
              <div className="flex items-center gap-x-2">
                <Input disabled value={fullInviteLink} className="w-full" />
                <Button
            ...
            <Button
              ...
              size="sm"
              variant="destructive"
              disabled={isPending || isResettingInvieCode}
